...
BuildRequires: fedora-release-kinoite
...
BuildRequires: kaccounts-integration-qt6
BuildRequires: kaccounts-providers
BuildRequires: kamera
BuildRequires: kbd
BuildRequires: kcharselect
BuildRequires: kde-connect
BuildRequires: kde-gtk-config
BuildRequires: kde-inotify-survey
BuildRequires: kde-partitionmanager
BuildRequires: kde-settings-pulseaudio
BuildRequires: kdegraphics-thumbnailers
BuildRequires: kdeplasma-addons
BuildRequires: kdialog
BuildRequires: kdnssd
BuildRequires: kernel
BuildRequires: kernel-modules
BuildRequires: kernel-modules-extra
BuildRequires: kf6-baloo-file
BuildRequires: kfind
BuildRequires: khelpcenter
BuildRequires: kinfocenter
BuildRequires: kio-admin
BuildRequires: kio-gdrive
BuildRequires: kmenuedit
BuildRequires: kmousetool
BuildRequires: konsole
BuildRequires: krfb
BuildRequires: kscreen
BuildRequires: kscreenlocker
BuildRequires: kwalletmanager5
BuildRequires: kwin
...
BuildRequires: plasma-desktop-doc
BuildRequires: plasma-discover
BuildRequires: plasma-discover-notifier
BuildRequires: plasma-disks
BuildRequires: plasma-drkonqi
BuildRequires: plasma-nm
BuildRequires: plasma-nm-openconnect
BuildRequires: plasma-nm-openvpn
BuildRequires: plasma-nm-vpnc
BuildRequires: plasma-pa
BuildRequires: plasma-print-manager
BuildRequires: plasma-systemmonitor
BuildRequires: plasma-thunderbolt
BuildRequires: plasma-vault
BuildRequires: plasma-welcome
BuildRequires: plasma-workspace
BuildRequires: plasma-workspace-geolocation
BuildRequires: plasma-workspace-wallpapers
BuildRequires: plasma-workspace-wayland
...
BuildRequires: sddm
BuildRequires: sddm-breeze
BuildRequires: sddm-kcm
BuildRequires: sddm-wayland-plasma
BuildRequires: selinux-policy-targeted
BuildRequires: setup
BuildRequires: shadow-utils
BuildRequires: shim-ia32
BuildRequires: shim-x64
BuildRequires: signon-kwallet-extension
